...
float SX1278_RSSI_LoRa_correct(SX1278_t *module) {
	float RSSI = -164 + SX1278_SPIRead(module, LR_RegRssiValue);
	return RSSI;
}

float SX1278_LastPacketRSSI_LoRa(SX1278_t *module) {
	float lastPacketRSSI = -164 + SX1278_SPIRead(module, LR_RegPktRssiValue);
	float lastPacketSNR = SX1278_LastPacketSNR_LoRa(module);
...
float SX1278_LastPacketSNR_LoRa(SX1278_t *module) {
	int8_t rawSNR = (int8_t)SX1278_SPIRead(module, LR_RegPktSnrValue);
	return (rawSNR / 4.0);
}
